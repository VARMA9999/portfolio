...
const CyberShieldGraphic: React.FC = () => (
  <div
    className="hero-float relative flex items-center justify-center w-[450px] h-[500px] sm:w-[540px] sm:h-[590px] md:w-[580px] md:h-[650px] lg:w-[660px] lg:h-[740px] xl:w-[750px] xl:h-[840px] max-w-full transform -translate-y-2 md:-translate-y-12 lg:-translate-y-20 xl:-translate-y-28"
  >
  ...
  return (
    <div className="relative min-h-[88vh] flex flex-col items-center justify-center
      pt-[48px] md:pt-[48px] sm:pt-[32px] pb-16 overflow-hidden bg-bg-primary">
        ...
        <div className="container mx-auto max-w-7xl px-[clamp(1.5rem,6vw,4rem)] lg:px-[clamp(3rem,8vw,7rem)] xl:px-[clamp(4rem,10vw,9rem)] relative z-10 w-full">
