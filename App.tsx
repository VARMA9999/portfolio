...
const AppContent = () => {
  ...
  useEffect(() => {
    ...
    if (location.pathname.startsWith('/blog')) {
      ...
      return;
    } else if (location.pathname === '/research-hub' || location.pathname === '/research') {
      setActiveSection('research-hub');
      return;
    } else if (location.pathname === '/vulnerabilities') {
      setActiveSection('vulnerabilities');
      return;
    } else if (location.pathname === '/legal-use') {
      setActiveSection('legal-use');
      return;
    } else if (location.pathname === '/copyright') {
      setActiveSection('copyright');
      return;
    }
